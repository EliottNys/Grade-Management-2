...
For our API REST, we generate our documentation schema using OpenAPI.<br/> The OpenAPI file was automatically generated by Swagger.
...
[database-diagram]: ./database_schema.pdf
[license]: ./LICENSE.md
